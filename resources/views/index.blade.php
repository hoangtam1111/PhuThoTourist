...
@section('content')
    ...
    <!-- Content -->
    <div class="container-xl mt-5 content">
        <div class="">
            <div class="about p-5 mb-6">
                <div class="row">
                    ...
                    <div class="col-12 col-md-6 col-lg-6 image">
                        <img class="image-about-first" src="{{ asset('image/background/Rectangle 11.png') }}" alt="">
                        <img class="image-about-second" src="{{ asset('image/background/Rectangle 12.png') }}" alt="">
                    </div>
                </div>
            ...
            <div class="new-post text-center mt-5">
                ...
                <p class="text-light mt-3 mb-4">Hãy cùng chúng tôi chia sẻ những bài viết mới với các thông tin về những sản phẩm du lịch</p>
                <div class="row justify-content-center">
                    <div class="col-3">
                        <div class="card" >
                            <img src="{{ asset('image/post/post1.png') }}" class="card-img-top" alt="...">
                            <div class="text-start p-3">
                                <div class="d-flex align-items-center role mb-2">Admin <div class="circle ms-1"></div></div>
                                <div class="title mb-2">Thông báo kết quả lựa chọn nhà thầu 2 màn hình Led P4 Outdoor Fullcolor</div>
                                <p class="text">Công ty Cổ phần Dịch vụ Du lịch Phú Thọ thông báo đến các nhà thầu tham gia chào hàng cạnh tranh Gói thầu: Cung cấp, lắp đặt 02 màn..</p>
                            </div>
                            <div class="ps-3">
                                ...
                                <div class="information d-flex align-items-center mb-3">
                                    <div class="view">10N lượt xem</div> <div class="circle-gray ms-1 me-1"></div> <div class="date">20/02/2022</div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="central-service text-center pt-4 pb-5 mb-4">
                ...
                <div class="underline"></div>
                <p class="text mt-3 mb-4">3 dịch vụ trọng tâm của Phuthotourist là vui chơi giải trí, nhà hàng – khách sạn, và dịch vụ lữ hành</p>
                <div class="row justify-content-center">
                    <div class="col-3">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">Với 2 khu giải trí nổi tiếng TP.HCM là Công viên văn hóa Đầm Sen, và khu du lịch sinh thái Vàm Sát (H.Cần Giờ)...</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-3">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">Với hệ thống khách sạn Phú Thọ và Ngọc Lan đạt chuẩn 3 sao, chuyên tiếp đón các đoàn thể thao....</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-3">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">Tổ chức các tour trong và ngoài nước với Trung tâm Dịch vụ du lịch Đầm Sen. Ngoài ra Trung tâm còn thế mạnh là tổ chức...</p>
                            </div>
                        </div>
                    </div>
                </div>
